...
export class ValidationComponent {
	...
	editFG() {
		this.stuFG = this._fb.group({
			...
			age: [this.editObj.age, [Validators.required, Validators.min(1), Validators.max(18), Validators.minLength(2), Validators.pattern('^[0-9]+$'), ZeroIsInvalidAtStartValidator, phoneNumberValidator]],
